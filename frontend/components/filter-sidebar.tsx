              ...
              <div className="space-y-2">
                {selectedLocation && (
                  <div className="flex items-center justify-between bg-blue-50 px-3 py-2 rounded-md">
                    <span className="text-sm text-blue-700">{selectedLocation}</span>
                    <button onClick={() => onLocationChange("")} className="text-blue-500 hover:text-blue-700">
                      <X className="h-3 w-3" />
                    </button>
                  </div>
                )}
                {selectedCompany && (
                  <div className="flex items-center justify-between bg-green-50 px-3 py-2 rounded-md">
                    <span className="text-sm text-green-700">{selectedCompany}</span>
                    <button onClick={() => onCompanyChange("")} className="text-green-500 hover:text-green-700">
                      <X className="h-3 w-3" />
                    </button>
                  </div>
                )}
                {
                  selectedJobRole && (
                    <div className="flex items-center justify-between bg-purple-50 px-3 py-2 rounded-md">
                      <span className="text-sm text-purple-700">{selectedJobRole}</span>
                      <button onClick={() => onJobRoleChange("")} className="text-purple-500 hover:text-purple-700">
                        <X className="h-3 w-3" />
                      </button>
                    </div>
                  )
